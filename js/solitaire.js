...
**********/
const Game = (() => {
  const UnconnectedGame = ({ congratulation }) => /*#__PURE__*/
  React.createElement("div", { id: "container" }, /*#__PURE__*/
  React.createElement("div", { className: "header" }, /*#__PURE__*/
  React.createElement(Stock, null), /*#__PURE__*/
  React.createElement(Foundation, null)), /*#__PURE__*/

  React.createElement(Tableau, null), /*#__PURE__*/
  React.createElement("div", { className: "congratulation",
    style: { visibility: congratulation ? 'visible' : 'hidden' } }, /*#__PURE__*/
  React.createElement("h1", null, "Congratulation, you did it!")));
...
const Stock = (() => {
  const UnconnectedStock = ({ rest, flopped }) => /*#__PURE__*/
  React.createElement("div", { className: "stock" }, /*#__PURE__*/
  React.createElement("div", { className: "rest" },
  rest.map((card) => /*#__PURE__*/
  React.createElement("div", { className: "cardContainer",
    key: JSON.stringify({ suit: card.suit, number: card.number }) }, /*#__PURE__*/
  React.createElement(Card, { key: JSON.stringify({ suit: card.suit, number: card.number }),
    suit: card.suit, number: card.number,
    stack: true,
    turned: card.turned, locked: card.locked, last: false })))), /*#__PURE__*/



  React.createElement("div", { className: "flop" },
  flopped.map((card) => /*#__PURE__*/
  React.createElement("div", { className: "cardContainer",
    key: JSON.stringify({ suit: card.suit, number: card.number }) }, /*#__PURE__*/
  React.createElement(Card, { key: JSON.stringify({ suit: card.suit, number: card.number }),
    suit: card.suit, number: card.number,
...
const Foundation = (() => {
  const UnconnectedFoundation = ({ piles }) => /*#__PURE__*/
  React.createElement("div", { className: "foundation" },
  piles.map((pile, pileIndex) => /*#__PURE__*/
  React.createElement("div", { className: "pile", key: pileIndex },
  pile.cards.map((card) => /*#__PURE__*/
  React.createElement("div", { className: "cardContainer",
    key: JSON.stringify({ suit: card.suit, number: card.number }) }, /*#__PURE__*/
  React.createElement(Card, { key: JSON.stringify({ suit: card.suit, number: card.number }),
    suit: card.suit, number: card.number,
    turned: card.turned, locked: card.locked, last: card.last }))), /*#__PURE__*/
...
const Tableau = (() => {
  const UnconnectedTableau = ({ piles }) => /*#__PURE__*/
  React.createElement("div", { className: "tableau" },
  piles.map((pile, pileIndex) => /*#__PURE__*/
  React.createElement("div", { className: "pile", key: pileIndex },
  pile.cards.map((card, index) => /*#__PURE__*/
  React.createElement("div", { className: "cardContainer",
    key: JSON.stringify({ suit: card.suit, number: card.number }) }, /*#__PURE__*/
  React.createElement(Card, { key: JSON.stringify({ suit: card.suit, number: card.number }),
    suit: card.suit, number: card.number,
  ...
  class UnconnectedCard extends React.Component {
    ...
    render() {
      ...
      switch (this.props.suit) {
        case consts.HEART:
          suit = /*#__PURE__*/React.createElement(Heart, null);
          break;
        case consts.TILE:
          suit = /*#__PURE__*/React.createElement(Tile, null);
          break;
        case consts.CLOVER:
          suit = /*#__PURE__*/React.createElement(Clover, null);
          break;
        case consts.PIKE:
          suit = /*#__PURE__*/React.createElement(Pike, null);
          break;}

      return /*#__PURE__*/(
        React.createElement("div", { className: "card" }, /*#__PURE__*/
        React.createElement("div", { className: "cardFace frontFace",
          style: { transform: `rotateY(${this.state.rotation}deg)` },
          draggable: this.props.locked === false,
          onDragStart: this.dragStart,
          onDragEnd: this.dragEnd }, /*#__PURE__*/
        React.createElement("div", null, /*#__PURE__*/
        React.createElement("h1", { className: this.props.suit }, this.props.number),
        suit)), /*#__PURE__*/
...
const Heart = ({ zoom = false }) => /*#__PURE__*/
React.createElement("svg", { className: "suitIcon",
  width: zoom === true ? 40 : 20, height: zoom === true ? 40 : 20,
  viewBox: "0 0 20 20" }, /*#__PURE__*/
...
const Tile = ({ zoom = false }) => /*#__PURE__*/
React.createElement("svg", { className: "suitIcon",
  width: zoom === true ? 40 : 20, height: zoom === true ? 40 : 20,
  viewBox: "0 0 20 20" }, /*#__PURE__*/
...
const Clover = ({ zoom = false }) => /*#__PURE__*/
React.createElement("svg", { className: "suitIcon",
  width: zoom === true ? 40 : 20, height: zoom === true ? 40 : 20,
  viewBox: "0 0 20 20" }, /*#__PURE__*/
React.createElement("circle", { className: "clover", cx: "10", cy: "5", r: "4.5" }), /*#__PURE__*/
React.createElement("circle", { className: "clover", cx: "5", cy: "11", r: "4.5" }), /*#__PURE__*/
React.createElement("circle", { className: "clover", cx: "15", cy: "11", r: "4.5" }), /*#__PURE__*/
React.createElement("polygon", { className: "clover", points: "10 10, 13 20, 7 20" }));



const Pike = ({ zoom = false }) => /*#__PURE__*/
React.createElement("svg", { className: "suitIcon",
  width: zoom === true ? 40 : 20, height: zoom === true ? 40 : 20,
  viewBox: "0 0 20 20" }, /*#__PURE__*/
React.createElement("path", { className: "pike",
  d: " M 0 12  A 2.5 2.5 0 0 0 10 12  A 2.5 2.5 0 0 0 20 12 Q 16 4 10 0 Q 4 4 0 12" }), /*#__PURE__*/
...
const DropSite = (() => {
  class UnconnectedDropSite extends React.Component {
    ...
    render() {
      return /*#__PURE__*/(
        React.createElement("div", { className: "dropTarget",
          style: { visibility: this.props.visible ? 'visible' : 'hidden' },
          onDrop: this.drop, onDragOver: this.allowDrop }, /*#__PURE__*/
